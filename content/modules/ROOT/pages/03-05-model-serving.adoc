...
* To do this, click on the **Internal and external endpoint details** link under the **Inference endpoint** column.
* In the popup, you will see a few URLs for our model server.
+
[.bordershadow]
image::04/inference-url-3.png[]

* Note or copy the **External** url, which should be something like `\https://my-first-model-{user}.apps.cluster-x4rsj.x4rsj.sandbox2796.opentlc.com`
